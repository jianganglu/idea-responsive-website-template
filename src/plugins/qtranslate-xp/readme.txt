...
1. Download the plugin from [here](http://downloads.wordpress.org/plugin/qtranslate-xp.zip "qTranslate Plus").
...
== Changelog ==
= 3.7.2 =
* Fixed ppqtranslate_javascript.php

= 3.7.1 =
* Function for Wordpress 4.0 compatibility changed
* Fixed height for TinyMCE
* Some CSS changes in the administration
* Disabled fullscreen button. There will be a fix in the next releases.
